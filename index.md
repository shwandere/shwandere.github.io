...
{% include button.html text="Github" icon="github" link="https://github.com/shwandere" color="#0366d6" %} {% include button.html text="Linkedin" icon="linkedin" link="https://www.linkedin.com/in/shweta-sharma-47a49869" color="#f68140" %} {% include button.html text="Gmail" icon="gmail" link="shweta_s@cs.iitr.ac.in" color="#0d94e7" %} 
