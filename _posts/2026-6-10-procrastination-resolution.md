---
layout: post
title: "Procrastination Resolution"
date: 2026-6-10
...
<span style="background-color: yellow;">how much to rely on the framework that i created for myself in regards to research</span> :

I think you have to start from some point and that framework can help me starting the work. 

<span style="background-color: yellow;">what to do when you think you are not very adaptable thinking wise and how it can harm your research. how to develop it?</span> :
...
<span style="background-color: yellow;">I dont follow through the work I was doing previously. I start getting stuck in the trap of procrastination. In this case giving goals doesnot help.</span> :
...
What thing I will do in the next 2 hours ? 
I want to invest some time on the paper and some time on the conceptual map. 
Conceptual map is a long process and better to spend a short time for it. I will just start today. 
Then later focus on the paper, so that I can decide what things to discuss with Ma'am tomorrow : Give time to analyze the paper. 
